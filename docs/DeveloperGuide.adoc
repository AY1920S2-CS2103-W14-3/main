...
Step 2. The user executes the add assignment command [E.g. `st(add) t/CS2103 tP d/03-27 12:00 e/5`] to add the following assignments to the Schoolwork Tracker.
